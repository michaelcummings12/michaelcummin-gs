	...
	return (
		<main className="min-h-screen bg-black px-6 py-24 text-zinc-300 sm:py-32 lg:px-8">
			...
			<div className="mx-auto max-w-3xl">
				<h1 className="mb-4 text-4xl font-bold tracking-tight text-white sm:text-6xl"> Terms of Use </h1>
				<p className="mb-12 text-sm text-zinc-500"> Last updated: March 2026 </p>
				<div className="prose prose-invert prose-zinc max-w-none">
					<h2 className="mt-12 mb-6 text-2xl font-semibold text-white"> 1. Acceptance of Terms </h2>
					<p>
						By accessing or using the website located at https://www.michaelcummin.gs (the &quot;Site&quot;), you agree to be bound by these Terms of Use and all applicable
						laws and regulations. If you do not agree with any part of these Terms, you must not use this Site.
					</p>
					<p>
						{" "}
					...
					<h2 className="mt-12 mb-6 text-2xl font-semibold text-white"> 2. Intellectual Property Rights </h2>
					...
					<p>
						are the intellectual property of Don&apos;t Stop, LLC or their respective owners and are protected under applicable copyright, trademark, trade dress, and
						intellectual property laws.
					</p>
					<p> No license or ownership rights are transferred to you through your use of this Site. </p>
					<h2 className="mt-12 mb-6 text-2xl font-semibold text-white"> 3. Portfolio Work and Client Materials </h2>
					<p>
					...
					<h2 className="mt-12 mb-6 text-2xl font-semibold text-white"> 4. Restrictions on Use </h2> <p>You agree that you will not:</p>
					<ul className="list-disc space-y-2 py-4 pl-6">
					...
					<h2 className="mt-12 mb-6 text-2xl font-semibold text-white"> 5. Limited License </h2>
					<p>
					...
					<h2 className="mt-12 mb-6 text-2xl font-semibold text-white"> 6. AI, Data Mining, and Automated Access </h2>
					<p>
					...
					<h2 className="mt-12 mb-6 text-2xl font-semibold text-white"> 7. DMCA and Copyright Enforcement </h2>
					<p>
					...
					<h2 className="mt-12 mb-6 text-2xl font-semibold text-white"> 8. Disclaimer </h2>
					...
					<h2 className="mt-12 mb-6 text-2xl font-semibold text-white"> 9. Limitation of Liability </h2>
					<p>
						To the fullest extent permitted by law, Don&apos;t Stop, LLC shall not be liable for any indirect, incidental, consequential, or punitive damages arising out of
					...
					<h2 className="mt-12 mb-6 text-2xl font-semibold text-white"> 10. Indemnification </h2>
					<p>
						You agree to defend, indemnify, and hold harmless Don&apos;t Stop, LLC from and against any claims, damages, liabilities, costs, or expenses arising from your
						misuse of the Site or violation of these Terms.
					</p>
					<h2 className="mt-12 mb-6 text-2xl font-semibold text-white"> 11. External Links </h2>
					...
					<h2 className="mt-12 mb-6 text-2xl font-semibold text-white"> 12. Modifications to Terms </h2>
					...
					<h2 className="mt-12 mb-6 text-2xl font-semibold text-white"> 13. Governing Law </h2>
					<p> These Terms shall be governed by and construed in accordance with the laws of the State of Illinois, without regard to conflict of law provisions. </p>
					<p> Any disputes arising from these Terms shall be resolved exclusively in the state or federal courts located in Illinois. </p>
					<h2 className="mt-12 mb-6 text-2xl font-semibold text-white">14. Contact</h2>
