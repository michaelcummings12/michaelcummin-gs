	...
	return (
		<main className="min-h-screen bg-black px-6 py-24 text-zinc-300 sm:py-32 lg:px-8">
			...
			<div className="mx-auto max-w-3xl">
				<h1 className="mb-4 text-4xl font-bold tracking-tight text-white sm:text-6xl">Privacy Policy</h1>
				...
				<div className="prose prose-invert prose-zinc max-w-none">
					...
					<h2 className="mt-12 mb-6 text-2xl font-semibold text-white">1. Information We Collect</h2>
					...
					<h2 className="mt-12 mb-6 text-2xl font-semibold text-white">2. Cookies and Tracking Technologies</h2>
					...
					<h2 className="mt-12 mb-6 text-2xl font-semibold text-white">3. Analytics and Infrastructure Providers</h2>
					...
					<h2 className="mt-12 mb-6 text-2xl font-semibold text-white">4. How Information Is Used</h2>
					...
					<h2 className="mt-12 mb-6 text-2xl font-semibold text-white">5. Data Retention</h2>
					...
					<h2 className="mt-12 mb-6 text-2xl font-semibold text-white">6. Data Security</h2>
					...
					<h2 className="mt-12 mb-6 text-2xl font-semibold text-white">7. External Links</h2>
					<p>
					...
					<h2 className="mt-12 mb-6 text-2xl font-semibold text-white">8. Your Privacy Rights</h2>
					<p>
					...
					<h2 className="mt-12 mb-6 text-2xl font-semibold text-white">9. Automated Access and Data Collection</h2>
					<p>
					...
					<h2 className="mt-12 mb-6 text-2xl font-semibold text-white">10. Changes to This Policy</h2>
					...
					<h2 className="mt-12 mb-6 text-2xl font-semibold text-white">11. Contact</h2>
