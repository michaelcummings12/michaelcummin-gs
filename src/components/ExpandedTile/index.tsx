...
export const ExpandedTile: FunctionComponent<PropsWithChildren<ExpandedTileProps>> = ({ children, backgroundColor }) => {
	...
	return (
		<AnimatePresence>
			<motion.div variants={variants} initial="exit" animate="enter" exit="exit" className={clsx(backgroundColor, "text-black h-full w-full overflow-hidden rounded-t-3xl translate-y-0")}>
