...
const SvgLinkedinIcon = (props: SVGProps<SVGSVGElement>) => (
	<svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className="LinkedinIcon_svg__svg-inline--fa LinkedinIcon_svg__fa-linkedin-in LinkedinIcon_svg__fa-w-14" data-icon="linkedin-in" data-prefix="fab" viewBox="0 0 448 512" {...props}>
		<path
			fill="currentColor"
