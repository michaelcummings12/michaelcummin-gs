...
function SvgLinkedinIcon(props: React.SVGProps<SVGSVGElement>) {
	return (
		<svg aria-hidden="true" data-prefix="fab" data-icon="linkedin-in" className="LinkedinIcon_svg__svg-inline--fa LinkedinIcon_svg__fa-linkedin-in LinkedinIcon_svg__fa-w-14" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" {...props}>
