...
const SvgMediumIcon = (props: SVGProps<SVGSVGElement>) => (
	<svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className="MediumIcon_svg__svg-inline--fa MediumIcon_svg__fa-medium-m MediumIcon_svg__fa-w-16" data-icon="medium-m" data-prefix="fab" viewBox="0 0 512 512" {...props}>
		<path
			fill="currentColor"
