...
const SvgEnvelopeIcon = (props: SVGProps<SVGSVGElement>) => (
	<svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className="EnvelopeIcon_svg__svg-inline--fa EnvelopeIcon_svg__fa-envelope EnvelopeIcon_svg__fa-w-16" data-icon="envelope" data-prefix="far" viewBox="0 0 512 512" {...props}>
		<path
			fill="currentColor"
